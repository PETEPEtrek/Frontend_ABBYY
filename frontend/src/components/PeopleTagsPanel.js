...
import { PeopleTags} from "../data";
import {FilterContext} from "../filter-context";

const PeopleTagsPanel =  () => {
    const [open2, setOpen2] = useState(false)

    const [adds, setAdds] = useState([false, false, false, false])
    ...
    const [unselectedTags, setUnselectedTags] = useState(PeopleTags);
...
export default PeopleTagsPanel;