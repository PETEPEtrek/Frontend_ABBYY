...
import {CharacterTags} from "../data";

const CharacterTagsPanel =  () => {
    const [open2, setOpen2] = useState(false)

    const [adds, setAdds] = useState([false, false, false, false, false])
    ...
    const [unselectedTags, setUnselectedTags] = useState(CharacterTags);
...
export default CharacterTagsPanel;